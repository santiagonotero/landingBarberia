    ...
    <section id="contact" className="py-24 bg-gradient-to-b from-white to-gray-50 reveal">
      <div className="container-custom section-padding">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
          <RevealSection direction='up'>
            <div className="group h-full bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 justify-items-center">
